...
$albumDownloadPath = realpath($downloadDir . '/' . $albumName);
$albumDownloadExists = $albumDownloadPath && is_dir($albumDownloadPath) && strpos($albumDownloadPath, realpath($downloadDir)) === 0;
?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-right col-md-8 col-lg-9">
                                ...
                                <div class="gallery-top-content margin-bottom-25">
									...
									<ul class="album-attributes portfolio-nav" style="position: absolute; right: 0; top: 0; width: auto;">
